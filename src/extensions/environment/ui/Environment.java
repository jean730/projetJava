...
public class Environment extends JFrame {
  ...
  private void buildModel() {
    ...
    /*this.model = new GameModel(new
    Generator("assets/GrassLand/Terrain/Grassland_Terrain_Tileset.png",512,32).getTileMap(),new
    Point2D.Double(4000,100)); TreeGenerator.generate((GameModel)this.model);*/
