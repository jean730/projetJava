...
public class Camera {
  ...
  public void setTransform(double posX, double posY, double scale,
                           double rotation) {
  ...
  public Graphics graphics() { return (Graphics)graphics; }

  public BufferedImage getImage() { return cameraView; }
