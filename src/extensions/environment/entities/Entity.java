...
public abstract class Entity extends Shape {
  ...
  public Point2D.Double getDoubleLoc() { return doubleLoc; }
  ...
  public Rectangle getBounds() {
    return new Rectangle(this.getLoc().x, this.getLoc().y, sprite.getWidth(),
                         sprite.getHeight());
  }
  ...
  public boolean isColisionable() { return isColisionable; }
