...
public class GameModel extends Shape {
  ...
  public GameModel(TileMap tileMap, Point2D.Double playerPos,
    ...
    StaticEntity fire =
        new StaticEntity(new Point2D.Double(3900, 256),
                         "assets/Details/fire.png", "Fire"); // Entité
                                                             // de
                                                             // test
    ...
    this.addEntity(
        new Cloud(this, new Point2D.Double(-200, 50), -20,
                  "assets/GrassLand/Background/GrassLand_Cloud_1.png"));
    this.addEntity(
        new Cloud(this, new Point2D.Double(-100, 80), -30,
                  "assets/GrassLand/Background/GrassLand_Cloud_2.png"));
    this.addEntity(
        new Cloud(this, new Point2D.Double(0, 20), -20,
                  "assets/GrassLand/Background/GrassLand_Cloud_3.png"));
    this.addEntity(
        new Cloud(this, new Point2D.Double(100, 100), -40,
                  "assets/GrassLand/Background/GrassLand_Cloud_1.png"));
    this.addEntity(
        new Cloud(this, new Point2D.Double(250, 30), -10,
                  "assets/GrassLand/Background/GrassLand_Cloud_2.png"));
    this.addEntity(
        new Cloud(this, new Point2D.Double(400, 60), -50,
                  "assets/GrassLand/Background/GrassLand_Cloud_3.png"));
    this.addEntity(p);
    this.addEntity(fire);
    ...
    this.scoreShape.addAttributes(
        new ColorAttributes(false, false, Color.GRAY, Color.YELLOW));
  ...
  public void setPixie(Pixie pixie) { this.pixie = pixie; }

  public Pixie getPixie() { return pixie; }

  public SText getScoreShape() { return scoreShape; }
  ...
  public void addTiles() {
    int[][] newTextureMap = mergeTextureMaps(
        tileMap.getTextureMap(),
        new Generator("assets/GrassLand/Terrain/Grassland_Terrain_Tileset.png",
                      512, tileMap.getTextureMap().length,
                      tileMap.getTextureMap()[0].length)
            .getTileMap()
            .getTextureMap());
